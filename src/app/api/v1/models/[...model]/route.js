...
export async function GET(request, { params }) {
  try {
    ...
    if (kindFilter) {
      const data = await buildModelsList(kindFilter, { allowedModels: apiKeyLimit.limit?.models });
    ...
    const models = await buildModelsList([LLM_KIND], { allowedModels: apiKeyLimit.limit?.models });
